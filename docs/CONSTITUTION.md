# AI Studio Build — Security Constitution v4
...
- Preserve the current reply contract: 2,000-character reply limit, required client request ID, Privacy Guardian on every reply, latest-10-turn Gemini context, user/model conversation records, and `410` rejection for deleted or deleting entries.
