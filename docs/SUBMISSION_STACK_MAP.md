...
| Resilience and graceful degradation | External AI services can fail, time out, or return invalid output. | The fallback ladder and bounded retries improve reliability, while the original journal entry remains saved even when Gemini is unavailable.
