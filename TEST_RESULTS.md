...
| 60 | Deployment Rollback | Deploy a harmless test revision, route traffic to the known-good revision, verify / and /health, then restore traffic. | Traffic returns to the known-good immutable revision without deleting rules, secrets, images, or data. | [x] PASSED -s: ______ READY TO RUN - operator |
